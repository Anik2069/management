                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 style="text-align: center">Product Edit form</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form method="post" action="updatepro.php" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cname" name="p"
                                           value="<?php echo $n; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="address">Product Group</label>
                                    <input type="text" class="form-control" id="address" name="g"
                                           value="<?php echo $g; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="phone">Product unit</label>
                                    <input type="text" class="form-control" id="phone" name="u"
                                           value="<?php echo $u; ?>">
                                </div>
