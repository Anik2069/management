...
<div class="wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        <input type="text" name="pur1" class="form-control" placeholder="Product Name"
                                               required>
                                    </div>
                                    <div class="col-xs-3">
                                        <input type="text" name="pur2" class="form-control" placeholder="Product Units"
                                               required>
                                    </div>
                ...
                if (isset ($_POST['submit'])) {
                    ...
                    $age = mysqli_real_escape_string($connection, $_POST['pur']);
                    $Email = mysqli_real_escape_string($connection, $_POST['pur1']);

                    $dd=$_POST['pur2'];
                    $query1 = mysqli_query($connection, "insert into pd values(NULL,'$age','$Email','0','$dd')");
                    ...
                    <div class="box">
                        ...
                        <div class="table-responsive no-padding">
                            <table id="example1" class="table ">
                                ...
                                <?php
                                include "connection.php";
                                $result = mysqli_query($connection, "select * from pd order by id DESC");
                                $counter = 0;
 ...
 <td>
  <a href='../examples/pf.php?re=$row[id]' class='btn btn-success btn-sm'>
                  <span class='glyphicon glyphicon-plus'></span>
                  </a>
                  <a href='../forms/editpro.php?re=$row[id]' class='btn btn-warning btn-sm'>
                                  <span class='glyphicon glyphicon-edit'></span>
                                  </a>
                  <a  onclick='javascript:confirmationDelete($(this));return false;' href='deletepro.php?re=$row[id]' class='btn btn-danger btn-sm'>
