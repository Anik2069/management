                        ...
                        <div class="table-responsive no-padding">
                            ...
                            <table id="example1" class="table ">
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    $totalrecord1=0;
                                    $totalrecord2=0;
                                    $result1 = mysqli_query($connection, "select sum(total) as record from record3 where cid='$checkingid'");
                                    while ($row1 = mysqli_fetch_array($result1)){
                                        $totalrecord1= $row1['record'];
                                    }
                                    $result2 = mysqli_query($connection, "select sum(amount) as record1 from record4 where cid='$checkingid'");
