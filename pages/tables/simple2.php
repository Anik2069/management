          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                $result = mysqli_query($connection, "select * from client1");
...
<td>".$row['phone']."</td>
<td>".$row['email']."</td>
<td><a  onclick='javascript:confirmationDelete($(this));return false;' href='delete2.php?re=$row[bid]' class='btn btn-danger btn-sm'>
<span class='glyphicon glyphicon-remove'></span>
</a>
<a href='../examples/copy.php?re=$row[bid]' class='btn btn-danger btn-sm'>
