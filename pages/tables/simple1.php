...
<div class="wrapper">
  ...
  <td>
  <a href='../examples/profile2.php?re=$row[id]' class='btn btn-success btn-sm'>
                  <span class='glyphicon glyphicon-plus'></span>
                  </a>
                  <a href='../forms/edit1.php?re=$row[id] ' class='btn btn-warning btn-sm'>
                                  <span class='glyphicon glyphicon-edit'></span>
                                  </a>
                  <a  onclick='javascript:confirmationDelete($(this));return false;' href='delete1.php?re=$row[id]' class='btn btn-danger btn-sm'>
