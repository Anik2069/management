...
$_GET['rex'];
$r = $_GET['rex'];
$query = "select * from pd where id='$r'";
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                                ...
                                <div class="box-body box-profile">
                                    ...
                                    <ul class="list-group list-group-unbordered">
                                        <li class="list-group-item">
                                            <b>Product Name</b> <a class="pull-right"><?php echo $a ?></a>
                                        </li>
                                        <li class="list-group-item">
                                            <b>Product Group</b> <a class="pull-right"><?php echo $b;
                                                ?></a>
                                        </li>
                                        <li class="list-group-item">
                                            <b>Product Unit</b> <a class="pull-right"><?php echo $c;
                                                ?></a>
                                        </li>
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-xs-2">
                                        <button type="submit" name="submit" class="btn btn-block btn-success">Search
                                        </button>
                        ...
                        <table class="table table-hover">
                            ...
                            while ($res = mysqli_fetch_assoc($data)) {
                                if ($res['date'] >= $date11 && $res['date'] <= $date12) {
                                    echo "<tr>
                         <td>" . $res['date'] . "</td>
                          <td>" . $res['quantity'] . " " . $c . "</td>
                           <td>" . $res['pirce'] . "</td>
                         <td>" . $res['total'] . "</td>
                         <td><a  onclick='javascript:confirmationDelete($(this));return false;' href='deletepdb.php?xxx=$res[id]'><div class='col-md-3 col-sm-4'><i class='fa fa-fw fa-remove'></i></a> </td>
                         </tr>";
            ...
            <div class="row box">
                ...
                $tmp = $total1 - $total;
                ?>
                <h4 style="text-align: center"><?php echo $a ?>'s Buying Price: <?php echo $total ?> bdt</h4>
      ...
      <button class='btn-default'><a href='invoicepds.php?red=$r'>Print</a> </button></h2>
  "; ?>
