...
<div class="wrapper">
                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-xs-2">
                                        <span>Bank Name:</span>
                                    <select name="bank" required class="form-control" onchange="myfun(this.value)">
                                            <option>Select One</option>
                                            <?php
                                            $query = mysqli_query($connection, "select distinct bname from bank");
                                            while ($res = mysqli_fetch_assoc($query)) {
                                                ?>

                                                <option value="<?php echo $res['bname'] ?>"><?php echo $res['bname'] ?></option>
                                    ...
                                    <div class="col-xs-2">
                                        <span>Operation:</span>
                                        <SELECT name="opp" required class="form-control">
                                    ...
                                    <div class="col-xs-1">
                                     ...
                                     <div class="col-xs-2">
                                         <span>Medium:</span>
                                        <input type="text" name="name2" class="form-control" required placeholder="Enter Name"
                                               >
                                    </div>
  ...
  $bal2 = mysqli_real_escape_string($connection, $_POST['name2']);


                        $query1 = mysqli_query($connection, "insert into bankhistory values(NULL,'$d','$bname','$type','$id','$bal2','$bal')");
