...
$_GET['rex'];
$r=$_GET['re'];
$query="select * from client where id='$r'";
      ...
      <div>
        <div class="">
          ...
          <div class="col-md-6">
            <div class="box box-primary p">
              <div class="box-body box-profile">
                <img class="profile-user-img img-responsive img-circle" src="../forms/images1/<?php echo $im ?>" height="128" width="128" alt="User profile picture">
    <?php
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-xs-3">
                  <input type="text" name="pur" class="form-control" placeholder="Purpose" required>
                </div>
                  <div class="col-xs-2">
                      <input type="text" name="qunatity" class="form-control" placeholder="Quantity" required>
                  </div>
                <div class="col-xs-3">
                  <input type="text" name="amount" class="form-control" placeholder="amount" required>
                </div>
                <div class="col-xs-2">
                  <button type="submit" name="submit3" value="Add" class="btn btn-block btn-danger">Add</button>
          ...
          if(isset ($_POST['submit3'])){
              ...
              $qunatity= mysqli_real_escape_string($connection,$_POST['qunatity']);
              $cal=(double)$qunatity*(double)$HomeTown;

              $query1 = mysqli_query($connection,"insert into record3 values(NULL,'$age','$Email','$HomeTown','$r','$qunatity','$cal')");
        ...
        <div class="box box-success">
          ...
          <div class="box-body">
            <div class="row">
              ...
              <div class="col-xs-2">
                <button type="submit" name="submit1" value="Add" class="btn btn-block btn-success">Add</button>
          ...
          if(isset ($_POST['submit1'])){
              ...
              $total1=0;
              $tbb=0;
              $query = "select * from record3 where cid='$r' ORDER BY date DESC";
              $date = mysqli_query($connection, $query);
              while ($res = mysqli_fetch_assoc($date)) {
              ...
              $query = "select * from record4 where cid='$r' ORDER BY date DESC";
              $date = mysqli_query($connection, $query);
              while ($res = mysqli_fetch_assoc($date)) {
              ...
              $query1 = mysqli_query($connection,"insert into record4 values(NULL,'$age','$Email','$HomeTown','$r')");
                ...
                echo "<tr>
                         ...
                         <td>".$res['quantity']."</td>
                           <td>".$res['amount']."</td>
                             <td>".$res['total']."</td>
                         <td>
                         <a onclick='javascript:confirmationDelete($(this));return false;' href='delete2.php?xxx=$res[S]'><div class='col-md-3 col-sm-4'><i class='fa fa-fw fa-remove'></i></a> </td>
                         </tr>";
                $total=$total+(double)$res['total'];
              ...
              <table class="table table-hover">
                  ...
                  while ($res = mysqli_fetch_assoc($date)){
                      echo "<tr>
                         ...
                         <td>".$res['purpose']."</td>
                         <td>".$res['amount']."</td>
                         <td><a onclick='javascript:confirmationDelete($(this));return false;' href='delete3.php?xxx=$res[Serial]'><div class='col-md-3 col-sm-4'><i class='fa fa-fw fa-remove'></i></a> </td>
                         </tr>";
                      $total1=$total1+(double)$res['amount'];
