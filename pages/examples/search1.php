                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-xs-2">
                                        <button type="submit" name="submit"  class="btn btn-block btn-success">Search</button>
...
$tm=$total-$total1;
            ...
            <div class=\"row box\">
                <h4 style=\"text-align: center\">Total Amount: ". $total." </h4>
                <h4 style=\"text-align: center\">Total Payment: ". $total1." </h4>

                <h4 style=\"text-align: center\">Total Due: ".$tm."</h4>";
                                echo "
      ...
      <a href='invoice4.php?red=$r'><button class='btn btn-default'>Print </button></a></h2>
      </div>
  ";
