        ...
        <section class="invoice" id="HTMLtoPDF">
            ...
            <div class="row invoice-info">
                <div class="col-sm-6 invoice-col">
                    ...
                    <address>
                        <?php echo "
                    Product Name: <strong>" . $na . "</strong><br>Product Group: "
                            . $phne . "<br> Unit: "
                            . $em . "<br>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 table-responsive">
                    <table class="table table-striped">
                        ...
                        <?php
                        $date11 = $_SESSION['date'];
                        $date12 = $_SESSION['date1'];
                        $total = 0;
                        $query = "select * from buying where pid='$r' ORDER BY date ASC";
                        $date = mysqli_query($connection, $query);
                        while ($res = mysqli_fetch_assoc($date)) {
                ...
                <div class="col-xs-6 table-responsive">
                    <table class="table table-striped">
                        ...
                        <?php
                        $total1 = 0;
                        $query = "select * from selling where pid='$r' ORDER BY date ASC";
                        $date = mysqli_query($connection, $query);
                        while ($res = mysqli_fetch_assoc($date)) {
                            ...
                            if ($res['date'] >= $date11 && $res['date'] <= $date12) {
                                echo "<tr>
                         <td>" . $res['date'] . "</td>
                         <td>" . $res['quantity'] . " " . $em . "</td>
                         <td>" . $res['price'] . "</td> <td>" . $res['total'] . "</td>
                         </tr>";
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tr>
                                <th style="width:50%">সর্বমোট ক্রয় টাকা:</th>
                                <td> <?php echo $total ?></td>
                            </tr>
                            <tr>
                                <th>সর্বমোট বিক্রয় টাকা:</th>
