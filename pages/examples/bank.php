            ...
            <div class="row">
                ...
                <div class="col-md-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-3">
                                        ...
                                        <select name="type" class="form-control">
                                            ...
                                            <option value="Deposit">Checking accounts
                                            </option>
                                    ...
                                    <div class="col-xs-2">
                                        ...
                                        <input type="text" name="qunatity" class="form-control"
                                               placeholder="Account Number"
                                               required>
                                    </div>
                                    <div class="col-xs-2">
                                        <span>Balances:</span>
                                        <input type="text" name="amount" class="form-control" placeholder="Balance"
                                               required>
                                    </div>
                                    <div class="col-xs-2">
                                        <br>
                    ...
                    if (isset ($_POST['submit'])) {
                        ...
                        $id = mysqli_real_escape_string($connection, $_POST['qunatity']);
                        $bal = mysqli_real_escape_string($connection, $_POST['amount']);
                        $borobal = mysqli_query($connection, "select * from bank where number ='$id'");
$bain=count(mysqli_fetch_assoc($borobal));
                        if ($bain >= 1) {
                            ?>
                            <script>
                                window.alert("Same account Numeber");
                            </script><?php
                        } else {
                            $query1 = mysqli_query($connection, "insert into bank values(NULL,'$bname','$type','$id','$bal')");
                ...
                <div class="col-md-10">
                    <div class="nav-tabs-custom box-body table-responsive no-padding">
                        <table class="table table-hover">
                         ...
                         <td>
                         <a onclick='javascript:confirmationDelete($(this));return false;' href='bankd.php?xxx=$res[id]'><div class='col-md-3 col-sm-4'><i class='fa fa-fw fa-remove'></i></a> </td>
                         </tr>";
