...
<td><div class='btn-group'>
                ...
                <ul class='dropdown-menu' role='menu'>
                  <li><a href='../examples/profile2.php?re=$row[id]'>Leger</a></li>
                  <li><a href='../forms/edit1.php?re=$row[id]''>Edit Client</a></li>
                  <li><a onclick='javascript:confirmationDelete($(this));return false;' href='delete1.php?re=$row[id]'>Delete Client</a></li>
                </ul>
              </div></a></td>
