      ...
      <div>
        <div class="">
          ...
          <div class="col-md-6">
            <div class="box box-primary p">
              <div class="box-body box-profile">
                <img class="profile-user-img img-responsive img-circle" src="../../../pages/forms/images1/<?php echo $im ?>" height="128" width="128" alt="User profile picture">
    <?php
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp".$na."</h3>" ;
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-xs-2">
                  <button type="submit" name="submit" value="Add" class="btn btn-block btn-danger">Add</button>
          ...
          if(isset ($_POST['submit'])){
              ...
              $query1 = mysqli_query($connection,"insert into record3 values('','$age','$Email','$HomeTown','$r')");
        ...
        <div class="box box-success">
          ...
          if(isset ($_POST['submit1'])){
              ...
              $query1 = mysqli_query($connection,"insert into record4 values('','$age','$Email','$HomeTown','$r')");
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="nav-tabs-custom box-body table-responsive no-padding">
            ...
            <?php
            $total=0;
            $query="select * from record3 where cid='$r'";
            $date=mysqli_query($connection,$query);
            while ($res = mysqli_fetch_assoc($date)){
                echo "<tr>
                         <td>".$res['date']."</td>
                         ...
                         <td>".$res['amount']."</td>
                         <td>
                         <a href='delete2.php?xxx=$res[S]'><div class='col-md-3 col-sm-4'><i class='fa fa-fw fa-remove'></i></a> </td>
                         </tr>";
                $total=$total+(double)$res['amount'];
        ...
        <div class="col-md-6">
          <div class="nav-tabs-custom box-body table-responsive no-padding">
              <table class="table table-hover">
                  ...
                  <?php
                  $total1=0;
                  $query="select * from record4 where cid='$r'";
                  $date=mysqli_query($connection,$query);
                  while ($res = mysqli_fetch_assoc($date)){
                      echo "<tr>
                         <td>".$res['date']."</td>
                         <td>".$res['purpose']."</td>
                         <td>".$res['amount']."</td>
                         <td><a href='delete3.php?xxx=$res[Serial]'><div class='col-md-3 col-sm-4'><i class='fa fa-fw fa-remove'></i></a> </td>
                         </tr>";
    ...
    <div class="row box">
        ...
        <h4 style="text-align: center">Total Due: <?php echo $total1?> </h4>

        <h4 style="text-align: center">Total Payable:<?php echo $total-$total1?></h4>
   <?php  echo "
      <h2 style='text-align: right; padding-right:30px'><button class='btn-default'><a href='invoice2.php?red=$r'>Print</a> </button></h2>
  "; ?>
