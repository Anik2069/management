      ...
      <div>
        <div class="">
          ...
          <div class="col-md-6">
            <div class="box box-primary p">
              <div class="box-body box-profile">
                <img class="profile-user-img img-responsive img-circle" src="../../../pages/forms/images/<?php echo $im ?>" height="128" width="128" alt="User profile picture">
    <?php
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                if(isset ($_POST['submit'])){
                    ...
                    $query1 = mysqli_query($connection,"insert into record1 values('','$age','$Email','$HomeTown','$r','$quantity','$cal')");
            ...
            if(isset ($_POST['submit1'])){
                ...
                $query1 = mysqli_query($connection,"insert into record2 values('','$age','$Email','$HomeTown','$r')");
