        ...
        <div class="col-md-6 ">
          ...
          <div class="box box-primary ">
            ...
            <!-- form start -->
              ...
              $old=$_SESSION['user'];
              $n="";
              $query1 = mysqli_query($connection,"select * from manager where email='$old'");
            ...
            <form  method="post">
              ...
              <div class="box-body">
                  ...
                  <div class="form-group has-feedback">
                      <input type="password" class="form-control" name="pass2" placeholder="Old Password" required>
                  ...
                  <div class="form-group has-feedback">
                      <input type="password" class="form-control" name="pass1" placeholder="Retype password" required>
...
if($oldp==$_SESSION['password']){
    ...
    if($pass==$pass1){
        $query1 = mysqli_query($connection,"update manager set email='$email',password='$pass' where email='$old'");
        $_SESSION['user']=$email;
